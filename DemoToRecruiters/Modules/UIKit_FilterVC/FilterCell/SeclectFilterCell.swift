...
class SeclectFilterCell: UITableViewCell , NibInstantiatable
{
  ...
  func configureCell(item:String)
  {
    ...
    categoryImageView.layer.borderColor = UIColor(AppColor.UserDetailsScreenColors.UserDetailsBackGroundView().backgroundGradiantColor.first ?? Color.blue).withAlphaComponent(1).cgColor
